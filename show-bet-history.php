...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($type == 'Open') {
        ...
        AND betting.betting_time_type = '$type'
        AND betting.betting_status = 'Active'
        GROUP BY betting.b_game_cid, adjusted_betting_number";
    } elseif ($type == 'Close') {

        echo $msql = "SELECT betting.betting_number,betting.b_game_cid,CAST(betting.betting_number AS SIGNED) AS adjusted_betting_number, SUM(betting.betting_amount) AS total_amount
        FROM betting
        LEFT JOIN market ON betting.b_market_id = market.market_id
        LEFT JOIN member ON betting.b_member_id = member.member_id
        WHERE DATE(TRIM(betting.betting_date)) = DATE(trim('$bid_date'))
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-10 col-md-11">
                                            ...
                                            <div class="row">
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    ...
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[0][2] === null ? '0' : $data[0][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">01</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[1][2] === null ? '0' : $data[1][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">02</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[2][2] === null ? '0' : $data[2][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">03</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[3][2] === null ? '0' : $data[3][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">04</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[4][2] === null ? '0' : $data[4][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">05</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[5][2] === null ? '0' : $data[5][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">06</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[6][2] === null ? '0' : $data[6][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">07</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[7][2] === null ? '0' : $data[7][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">08</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[8][2] === null ? '0' : $data[8][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">09</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[9][2] === null ? '0' : $data[9][2]; ?></h3>
                                                </div>
                                                <!-- ========== -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">10</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[10][2] === null ? '0' : $data[10][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">11</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[11][2] === null ? '0' : $data[11][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">12</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[12][2] === null ? '0' : $data[12][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">13</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[13][2] === null ? '0' : $data[13][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">14</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[14][2] === null ? '0' : $data[14][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">15</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[15][2] === null ? '0' : $data[15][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">16</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[16][2] === null ? '0' : $data[16][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">17</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[17][2] === null ? '0' : $data[17][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">18</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[18][2] === null ? '0' : $data[18][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">19</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[19][2] === null ? '0' : $data[19][2]; ?></h3>
                                                </div>
                                                <!-- ========== -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">20</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[20][2] === null ? '0' : $data[20][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">21</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[21][2] === null ? '0' : $data[21][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">22</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[22][2] === null ? '0' : $data[22][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">23</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[23][2] === null ? '0' : $data[23][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">24</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[24][2] === null ? '0' : $data[24][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">25</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[25][2] === null ? '0' : $data[25][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">26</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[26][2] === null ? '0' : $data[26][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">27</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[27][2] === null ? '0' : $data[27][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">28</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[28][2] === null ? '0' : $data[28][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">29</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[29][2] === null ? '0' : $data[29][2]; ?></h3>
                                                </div>
                                                <!-- ============= -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">30</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[30][2] === null ? '0' : $data[30][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">31</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[31][2] === null ? '0' : $data[31][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">32</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[32][2] === null ? '0' : $data[32][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">33</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[33][2] === null ? '0' : $data[33][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">34</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[34][2] === null ? '0' : $data[34][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">35</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[35][2] === null ? '0' : $data[35][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">36</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[36][2] === null ? '0' : $data[36][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">37</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[37][2] === null ? '0' : $data[37][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">38</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[38][2] === null ? '0' : $data[38][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">39</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[39][2] === null ? '0' : $data[39][2]; ?></h3>
                                                </div>
                                                <!-- =========== -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">40</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[40][2] === null ? '0' : $data[40][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">41</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[41][2] === null ? '0' : $data[41][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">42</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[42][2] === null ? '0' : $data[42][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">43</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[43][2] === null ? '0' : $data[43][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">44</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[44][2] === null ? '0' : $data[44][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">45</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[45][2] === null ? '0' : $data[45][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">46</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[46][2] === null ? '0' : $data[46][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">47</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[47][2] === null ? '0' : $data[47][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">48</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[48][2] === null ? '0' : $data[48][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">49</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[49][2] === null ? '0' : $data[49][2]; ?></h3>
                                                </div>
                                                <!-- =========== -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">50</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[50][2] === null ? '0' : $data[50][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">51</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[51][2] === null ? '0' : $data[51][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">52</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[52][2] === null ? '0' : $data[52][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">53</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[53][2] === null ? '0' : $data[53][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">54</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[54][2] === null ? '0' : $data[54][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">55</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[55][2] === null ? '0' : $data[55][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">56</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[56][2] === null ? '0' : $data[56][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">57</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[57][2] === null ? '0' : $data[57][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">58</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[58][2] === null ? '0' : $data[58][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">59</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[59][2] === null ? '0' : $data[59][2]; ?></h3>
                                                </div>
                                                <!-- =========== -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">60</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[60][2] === null ? '0' : $data[60][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">61</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[61][2] === null ? '0' : $data[61][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">62</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[62][2] === null ? '0' : $data[62][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">63</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[63][2] === null ? '0' : $data[63][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">64</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[64][2] === null ? '0' : $data[64][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">65</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[65][2] === null ? '0' : $data[65][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">66</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[66][2] === null ? '0' : $data[66][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">67</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[67][2] === null ? '0' : $data[67][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">68</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[68][2] === null ? '0' : $data[68][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">69</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[69][2] === null ? '0' : $data[69][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">70</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[70][2] === null ? '0' : $data[70][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">71</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[71][2] === null ? '0' : $data[71][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">72</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[72][2] === null ? '0' : $data[72][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">73</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[73][2] === null ? '0' : $data[73][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">74</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[74][2] === null ? '0' : $data[74][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">75</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[75][2] === null ? '0' : $data[75][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">76</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[76][2] === null ? '0' : $data[76][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">77</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[77][2] === null ? '0' : $data[77][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">78</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[78][2] === null ? '0' : $data[78][2]; ?></h3>
                                                </div>

                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">79</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[79][2] === null ? '0' : $data[79][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">80</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[80][2] === null ? '0' : $data[80][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">81</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[81][2] === null ? '0' : $data[81][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">82</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[82][2] === null ? '0' : $data[82][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">83</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[83][2] === null ? '0' : $data[83][2]; ?></h3>
                                                </div>
                                                <!-- ======= -->
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">84</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[84][2] === null ? '0' : $data[84][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">85</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[85][2] === null ? '0' : $data[85][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">86</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[86][2] === null ? '0' : $data[86][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">87</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[87][2] === null ? '0' : $data[87][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">88</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[88][2] === null ? '0' : $data[88][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">89</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[89][2] === null ? '0' : $data[89][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">90</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[90][2] === null ? '0' : $data[90][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">91</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[91][2] === null ? '0' : $data[91][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">92</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[92][2] === null ? '0' : $data[92][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">93</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[93][2] === null ? '0' : $data[93][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">94</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[94][2] === null ? '0' : $data[94][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">95</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[95][2] === null ? '0' : $data[95][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">96</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[96][2] === null ? '0' : $data[96][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">97</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[97][2] === null ? '0' : $data[97][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">98</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[98][2] === null ? '0' : $data[98][2]; ?></h3>
                                                </div>
                                                <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                                    <h3 class="fs-24  text_red text-center">99</h3>
                                                    <h3 class="fs-24 text_green bg_grey text-center"><?php echo $data[99][2] === null ? '0' : $data[99][2]; ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[257][3]) ? $data[257][3] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[344][4]) ? $data[344][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[588][4]) ? $data[588][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[688][4]) ? $data[688][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[266][4]) ? $data[266][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            <h3 class="fs-24  text_red text-center">400</h3>
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[400][4]) ? $data[400][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            ...
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[889][4]) ? $data[889][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            <h3 class="fs-24  text_red text-center">600</h3>
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[600][4]) ? $data[600][4] : '0'; ?></h3>
                                        </div>
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                        ...
                                        <div class="col-4 col-md-2 col-lg-2 col-xl-2 px-2 col-xxl-1">
                                            <h3 class="fs-24  text_red text-center">677</h3>
                                            <h3 class="fs-24 text_green bg_grey text-center"><?php echo isset($data[677][4]) ? $data[677][4] : '0'; ?></h3>
                                        </div>
                                        <!-- ======= -->
