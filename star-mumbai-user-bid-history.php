                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control show-tick" id="market_id" name="market_id">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    $getsql = "SELECT * FROM market WHERE active_status != 'Removed' AND market_type='Starline' ";
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control show-tick" id="game_id" name="game_id">
                                                                ...
                                                                <?php 
                                                                  $getsql = "SELECT * FROM game WHERE game_id='1' OR game_id='2' OR game_id='3' OR game_id='4' ";
                                                                  $getqry = mysqli_query($conn, $getsql);
                                                                  $i = 1;
                                                                  if (mysqli_num_rows($getqry) > 0) {
                                                                     while ($row = mysqli_fetch_assoc($getqry)) {
