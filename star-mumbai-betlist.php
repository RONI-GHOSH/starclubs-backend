...
<body data-sidebar="dark">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-4">
                            <form method="post" action="apiz/betlistChangeNumber.php">
                                ...
                                <button type="submit" name="bet_submit" class="btn btn-success btn-round waves-effect">SAVE CHANGES</button>
    ...
    <div class="modal fade show" id="betDeleteModal" style=" padding-right: 16px;" aria-modal="true">
        ...
        $(document).ready(function(){
            $('#market_id').on('change', function() {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "apiz/stars_show_live_bet.php",
                    data : {
                        id: id,
                    },
    ...
    <script type="text/javascript">
        $("#betListDel").on('click',function(){
            ...
            $.ajax({
                type:"POST",
                url:"apiz/delete_show_live_bet.php",
                data:{id},
                success:function(data) {

                    // $("#deleteBetListMsg").show();
                    // setTimeout(function(){ $("#deleteBetListMsg").hide(); }, 3000);
                    ...
                    $.ajax({ //create an ajax request to display.php
                        type: "POST",
                        url: "apiz/mumbai_show_live_bet.php",
                        data : {
                            id: id,
                        },
                        success: function(dataResult) {
