...
if (mysqli_num_rows($getqry) > 0) {
    ...
    if (!mysqli_query($conn, $usql)) {
        // exit;
        // echo "<script>alert('Number Update Failed');window.location = 'lottery-number-declare-result-auto.php';</script>";
    } 
    else {
        ...
        // echo "<script>alert('Number Update Successfully');window.location = 'lottery-number-declare-result-auto.php';</script>";
    }
} 
else {
    if ($market_id == date('h:i a', strtotime("00:00:00"))) {
