    ...
    function setBet($member_id,$choice_id,$game_name,$game_id,$bet_amount,$bet_num,$betting_date,$bet_time,$statLineBatTime,$bet_status,$balance,$date_transection){
            $sql = "INSERT INTO colormarketbat(member_id, choice_id, game_name, game_id, bet_amount, bet_num,betting_date ,betting_time,statLineBatTime, active_status)VALUES ('$member_id','$choice_id','$game_name','$game_id','$bet_amount','$bet_num','$betting_date','$bet_time','$statLineBatTime','$bet_status')";
    		if (mysqli_query($GLOBALS['con'], $sql)) 
    		{
    			...
    			if(mysqli_query($GLOBALS['con'],$usql)){
    				...
    				$msql = "INSERT INTO colorbattrasectionhistory(transaction_id, transaction_amount, member_id, transaction_update_date, transaction_type, game_name,bat_number)
