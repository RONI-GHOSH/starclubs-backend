...
$upcoming = $timestamp + (28 * 60); // 10 minutes * 60 seconds per minute
$upcoming = date('H:i', $upcoming);

$recent = $timestamp - (10 * 60); // 10 minutes * 60 seconds per minute
$recent = date('H:i', $recent);

$sql = "SELECT * FROM colormarketlist WHERE active_status ='Active' AND market_time >='$recent' AND market_time<='$upcoming' LIMIT 7";
