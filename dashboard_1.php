                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Mumbai Kalyan Bid Details</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?php
                                            $starLinesql = "SELECT SUM(b.betting_amount) as idc FROM betting b JOIN market m ON b.b_market_id = m.market_id WHERE DATE(b.betting_date) = Date('$date') AND m.market_type = 'mumbai'";
                                            $starqry = mysqli_query($conn, $starLinesql);
                                            $starrow = mysqli_fetch_assoc($starqry);
                                            $starnum = $starrow['idc'] ?: '0';
                                            $tmsql = "SELECT SUM(transaction_amount) as idc FROM wallet_transaction WHERE DATE(transaction_update_date) LIKE '%$date%' AND game_name='StarLine' AND status='1' AND transaction_type = 'WinningBat'";
                                                ...
                                                <div class="col-md-12">
                                                    <div class="bid_history_box bhb_bid_amt" style="border: 1px dotted black;padding: 2px; margin:5px;">
                                                        <div class="row" style="align-items: baseline; padding:5px;">
                                                            ...
                                                            <div class="col-md-5">
                                                                <h5 style="font-size: 12px;" id="total_bid_amt"><i class="bx bx-rupee"></i><?php echo number_format($starnum, 2); ?></h5>
                                                            </div>
                                                            <div class="col-md-3 text-sm-right">
                                                                <button type="button" class="btn btn-primary waves-light btn-xs showbettbl" id="winner_btn">View</button>
                                                            </div>
                                                    ...
                                                    <div class="bid_history_box bhb_win_amt" style="border: 1px dotted black;padding: 2px; margin:5px;">
                                                        <div class="row" style="align-items: baseline; padding:5px;">
                                                            ...
                                                            <div class="col-md-5">
                                                                <h5 class="mb-0" style="font-size: 13px;" id="total_win_amt"><i class="bx bx-rupee"></i><?php echo number_format($tmnum, 2); ?></h5>
                                                            </div>
                                                            <div class="col-md-3 text-sm-right">
                                                                <button type="button" class="btn btn-primary waves-light btn-xs showwidtbl" id="winner_btn">View</button>
                                                            </div>
                                                    ...
                                                    <div class="bid_history_box bhb_win_amt" style="border: 1px dotted black;padding: 2px; margin:5px;">
                                                        <div class="row" style="align-items: baseline; padding:5px;">
                                                            ...
                                                            <div class="col-md-5">
                                                                <h5 class="mb-0" style="font-size: 13px;" id="total_refer_amt"><i class="bx bx-rupee"></i><?php echo "0.00"; ?></h5>
                                                            </div>
                                                            <div class="col-md-3 text-sm-right">
                                                                <button type="button" class="btn btn-primary waves-light btn-xs showwidtbl" id="winner_btn">View</button>
                                                            </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Starline Bid Details</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?php
                                            $starLinesql = "SELECT SUM(bet_amount) as idc FROM starlinemarketbat WHERE DATE(betting_date) = Date('$date')";
                                            $starqry = mysqli_query($conn, $starLinesql);
                                            $starrow = mysqli_fetch_assoc($starqry);
                                            $starnum = $starrow['idc'] ?: '0';
                                            $tmsql = "SELECT SUM(transaction_amount) as idc FROM wallet_transaction WHERE DATE(transaction_update_date) LIKE '%$date%' AND game_name='StarLine' AND status='1' AND transaction_type = 'WinningBat'";
