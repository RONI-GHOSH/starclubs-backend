        ...
        $.ajax({ //create an ajax request to display.php
            ...
            success: function(dataResult) {
                if (dataResult == "Yes") {
                    ...
                    // // getsubmit();
                    alert("Market Not Updated Successfully");window.location = "user-bid-history.php";
                }
                else
                {
                    // $("#updateMsg").show();
                    ...
                    // // getsubmit();
                    alert("Market Update Successfully");window.location = "user-bid-history.php";
