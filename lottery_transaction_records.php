                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                $msql = "SELECT colormarketbat.*, wallet_transaction.market_name, wallet_transaction.game_name, 
                                                wallet_transaction.transaction_amount, wallet_transaction.transaction_type, 
                                                wallet_transaction.transaction_update_date FROM colormarketbat LEFT JOIN wallet_transaction ON 
                                                colormarketbat.game_name = wallet_transaction.game_name WHERE colormarketbat.game_name = 'Lottery_Number' 
                                                AND (wallet_transaction.transaction_type = 'ReferAmt' OR 
