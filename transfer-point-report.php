...
<head>
    <meta charset="utf-8" />
    <title>Transfer Point Report</title>
...
<body data-sidebar="dark">
        ...
        <header id="page-topbar">
            <div class="navbar-header">
				...
				<i class="fa fa-fw fa-bars"></i>
                    ...
                    <button type="button" class="btn btn-sm px-3 font-size-16 header-item waves-effect" id="vertical-menu-btn">
				<b><a href="krisshmatka-admin">Home</a></b>
			</button>
                ...
                <div class="d-flex">
					...
					<i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="krisshmatka-admin/change-password"><i class="bx bx-user font-size-16 align-middle mr-1"></i> <span key="t-lock-screen">Change Password</span></a>
                            <a class="dropdown-item d-block" href="krisshmatka-admin/main-settings"><i class="bx bx-wrench font-size-16 align-middle mr-1"></i> <span key="t-settings">Settings</span></a>
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        <li>
                            <a href="krisshmatka-admin/dashboard" class="waves-effect mm-active">
                        ...
                        <li>
                            <a href="krisshmatka-admin/user-management" class="waves-effect">
                        ...
                        <li>
                            <a href="krisshmatka-admin/declare-result" class="waves-effect">
                        ...
                        <li>
                            <a href="krisshmatka-admin/winning-prediction" class="waves-effect">
                                <i class="bx bx-bullseye"></i>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/user-bid-history">Users Bid History</a></li>
                                <li><a href="krisshmatka-admin/customer-sell-report">Customer Sell Report</a></li>
                                <li><a href="krisshmatka-admin/winning-report">Winning Report</a></li>
                                <li><a href="krisshmatka-admin/transfer-point-report">Transfer Point Report</a></li>
                                <li><a href="krisshmatka-admin/bid-winning-report">Bid Win Report</a></li>
                                <li><a href="krisshmatka-admin/withdraw-report">Withdraw Report</a></li>
                                <li><a href="krisshmatka-admin/auto-deposite-history">Auto Deposit History</a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/fund-request-management">Fund Request</a> </li>
                                <li><a href="krisshmatka-admin/withdraw-request-management">Withdraw Request</a> </li>
                                <li><a href="krisshmatka-admin/add-fund-user-wallet-management">Add Fund (User Wallet)</a> </li>
                                <li><a href="krisshmatka-admin/bid-revert">Bid Revert</a> </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/game-name">Game Name</a> </li>
                                <li><a href="krisshmatka-admin/game-rates">Game Rates</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/single-digit">Single Digit</a></li>

                                <li><a href="krisshmatka-admin/jodi-digit">Jodi Digit</a> </li>

                                <li><a href="krisshmatka-admin/single-pana">Single Pana</a> </li>

                                <li><a href="krisshmatka-admin/double-pana">Double Pana</a> </li>

                                <li><a href="krisshmatka-admin/tripple-pana">Tripple Pana</a> </li>

                                <li><a href="krisshmatka-admin/half-sangam">Half Sangam</a> </li>

                                <li><a href="krisshmatka-admin/full-sangam">Full Sangam</a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/main-settings">Main Settings</a></li>
                                <li><a href="krisshmatka-admin/contact-settings">Contact Settings</a></li>
                                <li><a href="krisshmatka-admin/clear-data">Clear Data</a></li>
                                <li><a href="krisshmatka-admin/slider-images-management">Slider Images</a></li>
                                <li><a href="krisshmatka-admin/how-to-play">How To Play</a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/notice-management">Notice Management</a> </li>
                                <li><a href="krisshmatka-admin/send-notification">Send Notification</a> </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu mm-collapse" aria-expanded="false">
                                <li><a href="krisshmatka-admin/starline-game-name">Game Name</a></li>
                                <li><a href="krisshmatka-admin/starline-game-rates">Game Rates</a></li>
                                <li><a href="krisshmatka-admin/starline-user-bid-history">Bid History</a></li>
                                <li><a href="krisshmatka-admin/starline-decleare-result">Decleare Result</a></li>
                                <li><a href="krisshmatka-admin/starline-result-history">Result History</a></li>
                                <li><a href="krisshmatka-admin/starline-sell-report">Starline Sell report</a></li>
                                <li><a href="krisshmatka-admin/starline-winning-report">Starline Winning report</a></li>
                                <li><a href="krisshmatka-admin/starline-winning-prediction">Starline Winning Prediction</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="krisshmatka-admin/users-querys" class="waves-effect">
                                <i class="bx bxs-user-detail"></i>
                        ...
                        <li>
                            <a href="krisshmatka-admin/sub-admin-management" class="waves-effect">
                                <i class="bx bxs-user-detail"></i>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="date-picker">
                                                            <div class="input-group">
                                                                <input class="form-control digits" type="date" value="2021-03-22" name="transfer_date" id="transfer_date" max="2021-03-22">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="adminassets/js/customjs.js?v=6682"></script>
