...
<head>
    <meta charset="utf-8" />
    <title>Color Game Name Managment</title>
...
<body data-sidebar="dark">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <!-- <h4 class="card-title d-flex align-items-center justify-content-between">Color Game Name List <a class="btn btn-primary btn-sm btn-float" href="#addstarlinegameModal" role="button" data-toggle="modal">Add Game </a></h4> -->
                                    <table class="table table-striped table-bordered" id="sstarlinegameList">
                                        ...
                                        <tbody>
                                            ...
                                            $getsql = "SELECT * FROM colorMarketList WHERE active_status !='Removed' ";
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $timec; ?></td>
                                                        <td><?php echo $row['star_name']; ?></td>
                                                        <!--<td><?php echo $row['active_status']; ?></td>-->
                                                        <td>
                                                            <button type="button" class="btn btn-info waves-effect m-r-20" data-toggle="modal" data-target="#starlineModal<?php echo $row['id']; ?>">Edit</button>
                                                        <td>
                                                            <?php

                                                            if ($row['active_status'] == "Active") {
                                                                echo $hardStatus = "<div class='checkbox_select'>
                                            	            <input type='checkbox' id='hardstatus" . $is . "'  class='optin required checkbox-toggle' checked style='display: none; visibility: hidden;' onclick='userThreeChange_status(this);' alt='" . $is . "' data-normalone='" . $id . "'>
                                            	            <label for='hardstatus" . $is . "' class='optin required' name='threestatus" . $is . "'>" . $status_third . "</label>
                                            	        </div>";
                                                            } else {
                                                                echo $hardStatus = "<div class='checkbox_select'>
                                            	            <input type='checkbox' id='hardstatus" . $is . "' class='optin required checkbox-toggle'  style='display: none; visibility: hidden;' onclick='userThreeChange_status(this);' alt='" . $is . "' data-normalone='" . $id . "'>
                                            	            <label for='hardstatus" . $is . "' class='optin required' name='threestatus" . $is . "'>" . $status_third . "</label>
                                            	        </div>";
                                                            }
                                                            ?>
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="title" id="largeModalLabel">Color Game </h4>
                                                                    </div>
                                                                    <form method="POST" action="apiz/color-updategame.php">
                                                                        <div class="modal-body">
                                                                            <div class="row clearfix">
                                                                                <div class="col-sm-12">
                                                                                    <label for="market_name">Color Game Name </label>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="submit" name="update-color" class="btn btn-raised btn-primary btn-round waves-effect">Update Market</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
    ...
    <script type="text/javascript">
        function userThreeChange_status(cp) {
            ...
            $.post("apiz/change-color-status.php", {
                    id: $(cp).data('normalone'),
                    status: $(cp).is(':checked') == true ? 'Active' : 'Deactive'
                },
                function(data) {
                    if (data == 'fail') {
