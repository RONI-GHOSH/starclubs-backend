                                            ...
                                            <form name="gameSrchFrm" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="No Declared Result" name="declaredResults" id="declaredResults">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label>&nbsp;</label>
                                                        <button type="submit" class="btn btn-success btn-block" name="update-allot">Declare Allot</button>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        <label>&nbsp;</label>
                                                        <button type="button" class="btn btn-danger btn-block" name="delete-allot">Delete Result</button>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function populateDeclaredResults() {
                ...
                var color = $('#number').val();
                // alert(betdate);
                // alert(gameName);
                // alert(color);
                // AJAX request
                $.ajax({
                    url: 'apiz/populate_declared_results.php',
                    type: 'POST',
                    data: {
                        betdate: betdate,
                        gameName: gameName,
                    ...
                    success: function(response) {
                        ...
                        $('#declaredResults').html(response);
                    }
                });
            }

            // Trigger populateDeclaredResults function when date, game name, or color changes
            $('#starline_betdate, #starlinemarkettype, #number').change(function() {
