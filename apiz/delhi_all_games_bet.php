...
include '../includes/config.php';
	...
	$sql = "SELECT * FROM betting bet inner join market mar on bet.b_market_id=mar.market_id WHERE bet.betting_date='$betdate' AND bet.betting_status = 'Active' AND mar.market_type = 'delhi' ORDER BY bet.betting_id DESC";
