...
// $type = $_POST['type'];
$msql = "SELECT * FROM wallet_transaction wt inner join market mkt on wt.market_id = mkt.market_id WHERE date(wt.transaction_update_date) = date('$bid_date') AND wt.transaction_type='WinningBat' AND mkt.market_type = 'Starline' ORDER BY wt.w_transaction_id DESC ";
