...
if (isset($_POST['update-amount'])) {
    ...
    if($out <= 0) {
       echo '<script>alert("Rate Update Failed");window.location = "../delhi-game-rate.php";</script>';
    }else{
        echo '<script>alert("Rate Update Successfully");window.location = "../delhi-game-rate.php";</script>';
    }
}
