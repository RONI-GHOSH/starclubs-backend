...
if (isset($_POST['addmarket'])) {
    ...
    // $mlgame = implode(',', $_POST['selectgame']);
    $mlgame = $_POST['selectgame'];
    ...
    if (!empty($data)) {
        echo '<script>alert("Market Added Successfully");window.location = "game-name.php";</script>';
    } else {
        echo '<script>alert("Market Not Added Successfully");window.location = "game-name.php";</script>';
    }


    // $sql="INSERT INTO `market`( `market_name`, `market_type` , `market_open_time`, `market_close_time`, `market_create_date`, `market_update_date`, `active_status`) VALUES ('$market_name' , '$market_type' , '$motime' , '$mctime' , '$date.$time' , '$date.$time' , 'Active')";
    // if (mysqli_query($conn,$sql)) {
    //     $last_id = mysqli_insert_id($conn);

    //     foreach ($mlgame as $games) {
    //         $gsql = "INSERT INTO game_choice( market_id, market_game_id) VALUES ('$last_id' , '$games')";
    //         if (!mysqli_query($conn,$gsql)) {
    //             $error = "Fail to add Market";
    //         }else{
                                            ...
                                            <form method="POST" action="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <input type="time" id="market_open" name="market_open" required="" class="form-control" placeholder="Enter Market Open Time">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <input type="time" id="market_close" name="market_close" required="" class="form-control" placeholder="Enter Market Close Time">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-2">

                                                        <label for="select_game">Select Game</label>

                                                        <select class="form-control show-tick" id="selectgame" required="" name="selectgame">
                                                            <option value="">Select</option>
                                                            <?php
                                                            $getsql = "SELECT * FROM market_game WHERE game_name = 'Game'";
                                                            $getqry = mysqli_query($conn, $getsql);
                                                            $i = 1;
                                                            if (mysqli_num_rows($getqry) > 0) {
                                                                while ($row = mysqli_fetch_assoc($getqry)) {
                                                            ?>
                                                                    <option value="<?php echo $row['market_game_id']; ?>"><?php echo $row['game_name']; ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered" id="gameList">
                                        ...
                                        <tbody>
                                            ...
                                            $getsqldata = "SELECT * FROM market WHERE active_status !='Removed'AND market_type='mumbai' ";
                                            /* $getsql = "SELECT * FROM market WHERE active_status !='Removed' AND market_type='mumbai' ";*/
                                            $getqry = mysqli_query($conn, $getsqldata);
                                            $i = 1;
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form method="POST" action="apiz/marketstatus.php">
                                                    ...
                                                    <div class="modal fade" id="largeModal<?php echo $row['market_id']; ?>" tabindex="-1" role="dialog">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST" action="apiz/updatemarket.php">
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            ...
                                                                            <div class="row all_data">
                                                                                <div class="col-sm-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="form-group">
                                                                                            <input type="text" id="market_open" name="market_open_all" class="form-control" placeholder="Enter Market Open Time" value="">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-6">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="form-group">
                                                                                            <input type="text" id="market_close" name="market_close_all" class="form-control" placeholder="Enter Market Close Time" value="">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row one_data">
                                                                                ...
                                                                                ?>
                                                                                        ...
                                                                                        <div class="col-sm-6">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="form-group">
                                                                                                    <input type="text" id="market_open" name="market_open[]" class="form-control" placeholder="Enter Market Open Time" value="<?php echo $rowData['market_opentime']; ?>">
                                                                                        ...
                                                                                        <div class="col-sm-6">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <div class="form-group">
                                                                                                    <input type="text" id="market_close" name="market_close[]" class="form-control" placeholder="Enter Market Close Time" value="<?php echo $rowData['market_closetime']; ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
