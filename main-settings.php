...
if (isset($_POST['updateqrcode'])) {
    if ($_FILES["qr_code"]) {
        if (isset($_FILES["qr_code"]["name"]) && $_FILES["qr_code"]["error"] == UPLOAD_ERR_OK) {
            // Set a target directory to store uploaded files
            $targetDirectory = "qrcode/";
            ...
            // Get the uploaded file's name and move it to the target directory
            $uploadedFileName = basename($_FILES["qr_code"]["name"]);
            ...
            if (in_array($fileExtension, $allowedImageTypes)) {
                ...
                $targetPath = $targetDirectory . $uploadedFileName;

                if (move_uploaded_file($_FILES["qr_code"]["tmp_name"], $targetPath)) {
                    $qrcode = $_FILES["qr_code"]["name"];
                    $sql = "UPDATE admin SET qr_code='$uploadedFileName' WHERE id='1'";
                    if (!mysqli_query($conn, $sql)) {
                        $error = "Fail to Update Settings";
                    } else {
                        $msg = "Settings Updated Successfully";
                ...
                $error = "Invalid image type. Only PNG, JPEG, and JPG images are allowed.";
            }
        }
    }

    if ($_POST["qr_status"]) {
        $qrStatus = $_POST["qr_status"];
        $sql = "UPDATE admin SET qr_status='$qrStatus' WHERE id='1'";
        if (!mysqli_query($conn, $sql)) {
            $error = "Fail to Update Settings";
        } else {
            $msg = "Settings Updated Successfully";
...
if (isset($_POST['updateadminone'])) {
    ...
    $hold_amount_request = $_POST['hold_amount_request'];
    $withdraw_start_time = $_POST['withdrawal_start_time'];
    $withdraw_end_time = $_POST['withdrawal_end_time'];
    $min_deposit = $_POST['min_deposit_rate'];
    $max_deposite_rate = $_POST['max_deposite_rate'];
    $minimum_transfer = $_POST['minimum_transfer'];
    $maximum_transfer = $_POST['maximum_transfer'];
    $maximum_bid_amount = $_POST['maximum_bid_amount'];
    $maximum_bid_ank = $_POST['maximum_bid_ank'];
    $maximum_bid_jodi = $_POST['maximum_bid_jodi'];
    $maximum_bid_panna = $_POST['maximum_bid_panna'];
    $maximum_bid_sangam = $_POST['maximum_bid_sangam'];
    $minimum_bid_money = $_POST['minimum_bid_money'];
    $welcome_bonus = $_POST['welcome_bonus'];

    $sql = "UPDATE admin SET name='$name', email='$email', mobile='$mobile', whatsapp_number='$whatsapp_number', password='$password', upi_id='$upi_id', marchant_code='$marchant_code', min_betting_rate='$min_betting',min_withdreal_rate='$min_withdreal', withdraw_request_limit='$withdraw_request_limit',hold_amount_request='$hold_amount_request',withdrawal_start_time='$withdraw_start_time',withdrawal_end_time='$withdraw_end_time',max_withdrawal_rate='$max_withdrawal_rate', min_deposit_rate ='$min_deposit',max_deposite_rate='$max_deposite_rate' ,minimum_transfer='$minimum_transfer',maximum_transfer='$maximum_transfer',maximum_bid_amount='$maximum_bid_amount',maximum_bid_ank='$maximum_bid_ank',maximum_bid_jodi='$maximum_bid_jodi',maximum_bid_panna='$maximum_bid_panna',maximum_bid_sangam='$maximum_bid_sangam',minimum_bid_money='$minimum_bid_money',welcome_bonus='$welcome_bonus',otherupi_id='$upi_id' WHERE id='1'";
...
if (isset($_POST['updateamb'])) {
    ...
    $sql = "UPDATE admin SET  amb1='$amb1', amb2='$amb2', amb3='$amb3' WHERE id='1'";
...
if (isset($_POST['updateadmineight'])) {
    ...
    $sql = "UPDATE admin SET refer_type='$refer_type',  refer_description='$refer_description',refer_title='$refer_title',refer_amount='$refer_amount' WHERE id='1'";
...
if (isset($_POST['updatewhatsappmessage'])) {

    $whatsappmessage = $_POST['whatsappmessage'];

    $sql = "UPDATE admin SET  whatsappmessage='$whatsappmessage' WHERE id='1'";

    if (!mysqli_query($conn, $sql)) {
        $error = "Fail to Update Settings";
    } else {
        $msg = "Whatsapp Message Updated Successfully";
    }
}
                                ...
                                <div class="body">
                                    ...
                                    if (mysqli_num_rows($getqry) > 0) {
                                        while ($row = mysqli_fetch_assoc($getqry)) {
                                            ...
                                            $upi_id = $row['upi_id'];
                                            $rowqrcode = $row['qr_code'];
                                            $rowqrstatus = $row['qr_status'];
                                            ...
                                            $hold_amount_request = $row['hold_amount_request'];
                                            $withdraw_start_time = $row['withdrawal_start_time'];
                                            $withdraw_end_time = $row['withdrawal_end_time'];
                                            ...
                                            $maximum_bid_ank = $row['maximum_bid_ank'];
                                            $maximum_bid_jodi = $row['maximum_bid_jodi'];
                                            $maximum_bid_panna = $row['maximum_bid_panna'];
                                            $maximum_bid_sangam = $row['maximum_bid_sangam'];
                                    ...
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="market_close">Maximum Bid Amount Ank</label>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input type="text" id="maximum_bid_ank" name="maximum_bid_ank" class="form-control" value="<?php echo $maximum_bid_ank; ?>" placeholder="Maximum Bid Amount Ank">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="market_close">Maximum Bid Amount Jodi</label>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input type="text" id="maximum_bid_jodi" name="maximum_bid_jodi" class="form-control" value="<?php echo $maximum_bid_jodi; ?>" placeholder="Maximum Bid Amount Jodi">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="market_close">Maximum Bid Amount Panna</label>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input type="text" id="maximum_bid_panna" name="maximum_bid_panna" class="form-control" value="<?php echo $maximum_bid_panna; ?>" placeholder="Maximum Bid Amount Panna">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="market_close">Maximum Bid Amount Sangam</label>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input type="text" id="maximum_bid_sangam" name="maximum_bid_sangam" class="form-control" value="<?php echo $maximum_bid_sangam; ?>" placeholder="Maximum Bid Amount Sangam">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <label for="market_close">Hold Amount Request</label>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input type="text" id="hold_amount_request" name="hold_amount_request" class="form-control" value="<?php echo $hold_amount_request; ?>" placeholder="Hold Amount Request">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="market_close">Withdrawal Start Time</label>
                                                <div class="input-group" id="timepicker-input-group1">
                                                    <input id="timepicker" name="withdrawal_start_time" type="text" class="form-control" data-provide="timepicker" value="<?php echo $withdraw_start_time; ?>">
                                                    <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                                </div>

                                            </div>
                                            <div class="col-sm-4">
                                                <label for="market_close">Withdrawal End Time</label>
                                                <div class="input-group" id="timepicker-input-group1">
                                                    <input id="timepicker" name="withdrawal_end_time" type="text" class="form-control" data-provide="timepicker" value="<?php echo $withdraw_end_time; ?>">
                                                    <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                                </div>
                                        ...
                                        <hr class="m-0">
                                        <br>
                                        <h5 style="color:blue;">QR Code</h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label">QR Code Status</label>
                                                    <select class="form-control" name="qr_status">
                                                        <option <?php if ($rowqrstatus == 'Active') {
                                                                    echo 'selected';
                                                                }  ?> value="Active">Active</option>
                                                        <option <?php if ($rowqrstatus == 'Inactive') {
                                                                    echo 'selected';
                                            ...
                                            <?php if ($rowqrcode) {  ?>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="col-form-label">QR Code</label>
                                                        <img src="<?php echo $baseUrl . '/hmroyal/qrcode/' . $rowqrcode; ?>" height="150" width="150">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div class="form-group m-4 text-sm-right">
                                        ...
                                        <br />
                                        <h5 style="color:blue;">Add Amount Bonus %</h5>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label">500 t0 1000</label>
                                                    <input class="form-control" type="text" name="amb1" value="<?= $amb1 ?>" Required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label">1001 t0 2000</label>
                                                    <input class="form-control" type="text" name="amb2" value="<?= $amb2 ?>" Required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label">More than 2000</label>
                                                    <input class="form-control" type="text" name="amb3" value="<?= $amb3 ?>" Required>
                                                </div>
                                            </div>
                                            <div class="form-group m-4 text-sm-right">
                                                <button type="submit" style="text-align:right;" name="updateamb" class="btn btn-raised btn-primary btn-round waves-effect">Update</button>
                                            </div>
                                        </div>
                                        <br />
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" type="text" name="youtube_description" id="editor1" value="<?= $youtube_description ?>" placeholder="Enter Youtube Link" data-original-title="" title=""><?= $youtube_description ?></textarea>
                                                    <script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" type="text" name="refer_description" id="editor2" value="<?= $refer_description ?>" placeholder="Enter Refer Description" data-original-title="" title=""><?= $refer_description ?></textarea>
                                                    <script>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-form-label">Refer Type</label>
                                                    <select class="form-control" name="refer_type" style="height: 57px;">
                                                        <option <?php if ($refer_type == 'Loss Betting') {
                                                                    echo 'selected';
                                                                }  ?> value="Loss Betting">Loss Betting</option>
                                                        <option <?php if ($refer_type == 'Flat') {
                                                                    echo 'selected';
                                        ...
                                        <hr class="m-0">
                                        <br>
                                        <h5 style="color:blue;">Whatsapp Message for User View Table</h5>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-form-label">Message</label>
                                                    <input class="form-control" type="text" name="whatsappmessage" value="<?php echo $whatsappmessage; ?>" Required>
                                                </div>
                                            </div>
                                            <div class="form-group m-4 text-sm-right">
                                                <button type="submit" style="text-align:right;" name="updatewhatsappmessage" class="btn btn-raised btn-primary btn-round waves-effect">Update</button>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group m-4 text-sm-right">
