                                ...
                                <div class="col-sm-12 col-12 ">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="theme-form mega-form" action="apiz/delhi-update-game-rate.php" name="gameRatesFrm" method="post">
                                        ...
                                        <?php } }?>
                                        <?php 
                                            $getsql = "SELECT * FROM game_rate WHERE game_name = 'Single Andar'";
                                            $getqry = mysqli_query($conn, $getsql);
                                            $i = 1;
                                            if (mysqli_num_rows($getqry) > 0) {
                                             while ($row = mysqli_fetch_assoc($getqry)) {
                                        ...
                                        <?php 
                                            $getsql = "SELECT * FROM game_rate WHERE game_name = 'Single Bahar'";
                                            $getqry = mysqli_query($conn, $getsql);
                                            $i = 1;
                                            if (mysqli_num_rows($getqry) > 0) {
                                             while ($row = mysqli_fetch_assoc($getqry)) {
