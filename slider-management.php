...
if (isset($_POST['add-slider'])) {
    ...
    $name = "adminassets/images/slider_images/$newfilename";
    move_uploaded_file($post_tmp_img1,"$name");
    
    $sql="INSERT INTO offertable(offerimage, status) VALUES ('$name','Active')";
    
    if (!mysqli_query($conn,$sql)) {
            $error = "Fail to Add Slider Image";
        }else{
            $msg = "Slider Image Add Successfully";
        }
}
...
<head>
    <meta charset="utf-8" />
    <title>Slider Image Managment</title>
...
<body data-sidebar="dark">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php $i++;} }else {
                                        echo " <tr>
                                            <td colspan='5' style='text-align:center;'>No Slider Image Found</td>
                                        </tr> ";
                                    }
    ...
    <script type="text/javascript">
        $("#sliderDelete").on('click',function(){
            ...
            $.ajax({
                type:"POST",
                url:"apiz/delete_image_slider.php",
                data:{id},
                success:function(data) {
                    window.location.href="slider-management.php";
