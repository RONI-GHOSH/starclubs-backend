                                    ...
                                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['submit'])) {
                                                ...
                                                $msql = "SELECT betting.*, wallet_transaction.market_name, wallet_transaction.game_name, 
                                                wallet_transaction.transaction_amount, wallet_transaction.transaction_type, 
                                                wallet_transaction.transaction_update_date FROM betting LEFT JOIN wallet_transaction ON 
                                                betting.token = wallet_transaction.token WHERE betting.token != '' AND 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="market_close">Total Referral Amount</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" style="background-color:azure" value="<?php echo $tra; ?> Rs" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="market_close">Total Referral Amount</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" style="background-color:lightgreen" value="<?php echo $tra; ?> Rs" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="market_close">Profit/Loss</label>
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="market_close">Total Referral Amount</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control" style="background-color:lightsalmon" value="<?php echo $tra; ?> Rs" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="market_close">Profit/Loss</label>
