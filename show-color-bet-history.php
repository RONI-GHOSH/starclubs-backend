...
<body data-sidebar="dark">
        ...
        $(document).ready(function() {
            $('.clear-result').on('click', function() {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "apiz/clear-color-winning.php",
                    data: {
                        mkid,
                        datee,
                    },
            ...
            if (marketid != '') {
                if (betdate != '') {
                    ...
                    $('#bid-history').DataTable({
                        destroy: true,
                        "ajax": "apiz/get_color_bidhistory.php?marketid=" + marketid + "&betdate=" + betdate,
                        "data": [],
                    });
    ...
    <script type="text/javascript">
        $("#catHistoryDel").on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "apiz/deleteDeclareColorResult.php",
                data: {
                    id
                },
