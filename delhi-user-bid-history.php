...
<body data-sidebar="dark">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control show-tick" id="game_id" name="game_id">
                                                                <option value="">- Please Select Game Name -</option>z
                                                                <?php
                                                                $getsql = "SELECT * FROM game WHERE game_name = 'Jodi Digit' AND market_type='delhi'";
                                                                $getqry = mysqli_query($conn, $getsql);
                                                                $i = 1;
                                                                if (mysqli_num_rows($getqry) > 0) {
                                                                    while ($row = mysqli_fetch_assoc($getqry)) {
                                                                ...
                                                                <?php
                                                                $getsql = "SELECT * FROM game WHERE game_name = 'Single Andar' AND market_type='delhi'";
                                                                $getqry = mysqli_query($conn, $getsql);
                                                                $i = 1;
                                                                if (mysqli_num_rows($getqry) > 0) {
                                                                    while ($row = mysqli_fetch_assoc($getqry)) {
                                                                ...
                                                                <?php
                                                                $getsql = "SELECT * FROM game WHERE game_name = 'Single Bahar' AND market_type='delhi'";
                                                                $getqry = mysqli_query($conn, $getsql);
                                                                $i = 1;
                                                                if (mysqli_num_rows($getqry) > 0) {
                                                                    while ($row = mysqli_fetch_assoc($getqry)) {
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <form>
                                        ...
                                        <label for="betting_amount">Points </label>
                                        <input class="form-control" type="text" name="betting_amount" id="betting_amount">
    ...
    <script type="text/javascript">
        function idtrans(el) {
            ...
            var bat_number1 = $(el).data('bat_number1');
            // alert(bat_amount);
            $("#betting_amount").val(bat_number1);
        }
    </script>
    ...
    <script type="text/javascript">
        function changebetNumber(eb) {
            ...
            var betting_amount = $("input[name=betting_amount").val();
            ...
            $.ajax({ //create an ajax request to display.php
                ...
                success: function(dataResult) {
                    ...
                    if (dataResult == "Yes") {
                        ...
                        // // getsubmit();
                        alert("Market Not Updated Successfully");
                        window.location = "delhi-user-bid-history.php";
                    } else {
                        // $("#updateMsg").show();
                        // setTimeout(function(){ $("#updateMsg").hide(); }, 3000);
                        // // getsubmit();
                        alert("Market Update Successfully");
                        window.location = "delhi-user-bid-history.php";
