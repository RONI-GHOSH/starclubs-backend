                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select id="market_id"  required="" name="market_id" class="form-control">
                                                            <option value="">- Please Select Starline Time -</option>
                                                        <?php 
                                                        $getsql = "SELECT * FROM starLineMarketList ";
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    <div class="row clearfix">
                        <div class="col-sm-4">
                            <form method="post" action="apiz/starlineBettingtestCode.php">
   ...
   <script type="text/javascript">
        ...
        $(document).ready(function(){
                ...
                // {
                    ...
                    $.ajax({ //create an ajax request to display.php
                        type: "POST",
                        url: "apiz/starline_Betting_fetch.php",
                        data : {
                             valTime,
                            dt},
    ...
    <script type="text/javascript">
        function changebetNumber(eb) {
            ...
            $.ajax({ //create an ajax request to display.php
                type: "POST",
                url: "apiz/starlineBettingtestCode.php",
                data : {
                ...
                success: function(dataResult) {
                    if (dataResult == "Yes") {
                        alert("Bid Update Failed");window.location = "starline-user-bid-history.php";
                    }
                    else
                    {
                        alert("Bid Update Successfully");window.location = "starline-user-bid-history.php";
                    }
                }
            });
        }
