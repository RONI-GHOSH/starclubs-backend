                ...
                <div class="page-content">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="row">
                                            <?php
                                                        $marketsql = "SELECT * FROM `market` WHERE active_status !='Removed'  AND market_type='delhi'";
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12"> 
                                                     <?php
                                                        $amsql = "SELECT SUM(b.betting_amount) as idc FROM betting b JOIN market m ON b.b_market_id = m.market_id WHERE DATE(b.betting_date) = Date('$date') AND m.market_type = 'delhi' AND b.b_market_id = '$marketid'";
