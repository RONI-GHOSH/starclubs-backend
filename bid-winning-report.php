...
<body data-sidebar="dark">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <div class="date-picker">
                                                            <div class="input-group">
                                                                <input class="form-control digits" type="date" value="2021-03-22" name="result_date" id="result_date" max="2021-03-22">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="adminassets/js/customjs.js?v=9701"></script>
