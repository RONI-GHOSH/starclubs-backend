...
if (isset($_POST['addmarket'])) {
    ...
    $sql = "call CreateStarLineMarket('" . $params . "')";

    $data = mysqli_query($conn, $sql);

    if (!empty($data)) {
        echo '<script>alert("Market Added Successfully");window.location = "star-game-name.php";</script>';
    } else {
        echo '<script>alert("Market Not Added Successfully");window.location = "star-game-name.php";</script>';
    }
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered" id="gameList">
                                        ...
                                        <tbody>
                                            ...
                                            $getsqldata = "SELECT * FROM market WHERE market_type='Starline' AND active_status !='Removed' ";
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form method="POST" action="apiz/starmarketstatus.php">
                                                    ...
                                                    <div class="modal fade" id="largeModal<?php echo $row['market_id']; ?>" tabindex="-1" role="dialog">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST" action="apiz/starupdatemarket.php">
                                                                    <div class="modal-body">
                                                                        <div class="row clearfix">
                                                                            ...
                                                                            ?>
                                                                                    ...
                                                                                    <!--    <div class="form-group">-->
                                                                                    <!--        <div class="form-group">-->
                                                                                    <!--            <input type="text" id="market_close" name="market_close[]" class="form-control" placeholder="Enter Market Close Time" value="<?php
                                                                                                                                                                                                                                    // echo $rowData['market_closetime'];
                                                                                                                                                                                                                                    ?>">-->
                                                                                    <!--        </div>-->
                                                                                    <!--    </div>-->
                                                                                    <!--</div> -->
